...
//                }
//                if (name.equals("")) {
//                    ToastUtils.showToast(TestActivity.this, R.string.qingshuruyonghuming);
//                } else {
...
//                        total = 1000000;
//                    }
//                    tvtotal.setText((getResources().getString(R.string.shengyuzonge) + StringUtils.getCommaDecimalsStr("" + total)));
//                    gvActTest.setThreadFlag(true);
//                    dialog.dismiss();
//                    ToastUtils.showToast(TestActivity.this, R.string.youxikaishi);
//                }
//                break;
...
//            showBet(num);
//        } else {
//            ToastUtils.showToast(TestActivity.this, R.string.yuebuzu);
//        }
//    }
//
...
//        switch (type) {
//            case 0:
//                ToastUtils.showToast(TestActivity.this, R.string.qingxuanzeyaoxiazhudeleixing);
//                break;
//            case 1://红
...
//
//                ToastUtils.showToast(TestActivity.this, getResources().getString(R.string.bencizhongjiangjinewei) + earings);
//                ToastUtils.showToast(TestActivity.this, R.string.youxikaishi);
//                tvtotal.setText((getResources().getString(R.string.shengyuzonge) + StringUtils.getCommaDecimalsStr("" + total)));
//                redAmout = 0;
//                yellowAmount = 0;
