 ...
 * version：          1.0
 * date：            2017/8/2
 * description：  我的项目--我的债权项目--项目详情--还款详情adapter
 * history：
 * ===================================================
 */

public class MyCreditorDetailsActLvAdapter extends BaseAdapter {
    private Context context;
    private List<TransferableDetailsBean.RecoverBean.ItemsBean> list;

    public MyCreditorDetailsActLvAdapter(Context context, List<TransferableDetailsBean.RecoverBean.ItemsBean> list) {
