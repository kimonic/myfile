...
/**
 * * ================================================
 * name:            RechargeRecordActLvAdapterN
 * guide:
 * author：          kimonik
 * version：          1.0
 * date：            2017/9/12
...
public class RechargeRecordActLvAdapterN extends BaseAdapter {
    private List<RechargeRecodeBean.ItemsBean> list;
    private Context context;

    public RechargeRecordActLvAdapterN(List<RechargeRecodeBean.ItemsBean> list, Context context) {
        this.list = list;
