 ...
 * version：          1.0
 * date：            2017/7/24
 * description：  RedPackageActivity中listview的adapter/返现券用
 * history：
 * ===================================================
 */

public class FanXianQuanActLvAdapter extends BaseAdapter {

    private List<FanXianQuanBean.ListBean> list;
    private Context context;
    private int type;

    public FanXianQuanActLvAdapter(FanXianQuanBean bean, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.redView.setOneText(StringUtils.getTwoDecimalsStr(list.get(position).getProportion()));
